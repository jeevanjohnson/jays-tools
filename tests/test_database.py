...
class TestSQLDatabaseSchemaEvolution:
    ...
    async def test_schema_evolution_insert_new_version(self, temp_db_path):
        ...
        class ItemV2(MigratableRow, previous_model=ItemV1):
            name: str = ""
            price: float = 0.0
